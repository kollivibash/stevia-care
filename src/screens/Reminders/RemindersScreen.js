...
const styles = StyleSheet.create({
  ...
  adherenceNum: { color: '#fff', fontSize: 20, fontWeight: '900' },
  adherenceLabel: { color: 'rgba(255,255,255,0.65)', fontSize: 10, fontWeight: '700', marginTop: 2 },
  ...
  slotLabel: { fontSize: 10, fontWeight: '700', marginTop: 2 },
  ...
  aiBannerText: { flex: 1, color: '#fff', fontSize: 14, fontWeight: '700' },
  ...
  medName: { fontSize: 14, fontWeight: '800' },
  medMeta: { fontSize: 11, marginTop: 2 },
  medDose: { fontSize: 11, marginTop: 2, fontStyle: 'italic' },
