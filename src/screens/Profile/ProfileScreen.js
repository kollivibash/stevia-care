...
const styles = StyleSheet.create({
  ...
  scoreBarLabel: { color: 'rgba(255,255,255,0.7)', fontSize: 11, fontWeight: '700', marginBottom: 6 },
  ...
  scoreBarSub: { color: 'rgba(255,255,255,0.45)', fontSize: 10, marginTop: 4 },
  scoreBarNum: { color: '#fff', fontSize: 32, fontWeight: '900' },
  ...
  premLabel: { color: 'rgba(255,255,255,0.5)', fontSize: 10, fontWeight: '800', letterSpacing: 1.5, marginBottom: 4 },
  premTitle: { color: '#fff', fontSize: 17, fontWeight: '900', marginBottom: 4 },
  premSub: { color: 'rgba(255,255,255,0.65)', fontSize: 11 },
  premPriceBox: { alignItems: 'center' },
  premPrice: { color: '#fff', fontSize: 26, fontWeight: '900' },
  premPer: { color: 'rgba(255,255,255,0.6)', fontSize: 11 },
  sectionTitle: { fontSize: 11, fontWeight: '800', letterSpacing: 1.5, marginBottom: 8, marginTop: 16, paddingHorizontal: 4 },
  menuCard: { borderRadius: 18, overflow: 'hidden', marginBottom: 4, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.04, shadowRadius: 8, elevation: 2 },
  ...
  footerName: { fontSize: 15, fontWeight: '900' },
  footerVer: { fontSize: 12 },
  ...
  langTitle: { fontSize: 20, fontWeight: '900', marginBottom: 4 },
  langSub: { fontSize: 12, marginBottom: 18 },
  ...
  langNative: { fontSize: 15, fontWeight: '800' },
  langEn: { fontSize: 10, fontWeight: '600', marginTop: 2 },
});
