...
const styles = StyleSheet.create({
  ...
  eyebrow: { color: 'rgba(255,255,255,0.5)', fontSize: 10, fontWeight: '800', letterSpacing: 2, marginBottom: 4 },
  headerTitle: { color: '#fff', fontSize: 28, fontWeight: '900' },
  headerSub: { color: 'rgba(255,255,255,0.65)', fontSize: 13, marginTop: 4, marginBottom: 20 },
  ...
  sectionTitle: { fontSize: 17, fontWeight: '900', marginBottom: 14, letterSpacing: -0.3 },
  ...
  modTitle: { fontSize: 14, fontWeight: '900', marginBottom: 4 },
  modSub:   { fontSize: 11, lineHeight: 15 },
  ...
  comingBadgeText: { color: '#fff', fontSize: 10, fontWeight: '900', letterSpacing: 1.5 },
  comingTitle: { color: '#fff', fontSize: 20, fontWeight: '900', marginBottom: 4 },
  comingSub:   { color: 'rgba(255,255,255,0.55)', fontSize: 12, marginBottom: 16 },
  ...
  comingLabel: { color: 'rgba(255,255,255,0.7)', fontSize: 10, fontWeight: '700', textAlign: 'center' },
});
