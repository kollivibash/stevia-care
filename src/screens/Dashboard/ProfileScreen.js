...
const styles = StyleSheet.create({
  ...
  name: { fontSize: SIZES.xl, fontWeight: '800', color: COLORS.textPrimary },
  email: { fontSize: SIZES.sm, color: COLORS.textSecondary, marginTop: 4 },
  card: { marginBottom: 16 },
  cardHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 },
  cardTitle: { fontSize: SIZES.md, fontWeight: '700', color: COLORS.textPrimary },
  infoRow: { flexDirection: 'row', alignItems: 'flex-start', marginBottom: 16 },
  infoIcon: { marginRight: 12, marginTop: 2 },
  infoLabel: { fontSize: SIZES.xs, color: COLORS.textMuted, fontWeight: '600' },
  infoValue: { fontSize: SIZES.base, color: COLORS.textPrimary, fontWeight: '500', marginTop: 1 },
