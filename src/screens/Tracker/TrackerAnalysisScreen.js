...
const styles = StyleSheet.create({
  ...
  promptTitle: { fontSize: SIZES.xl, fontWeight: '800', color: COLORS.textPrimary, textAlign: 'center' },
  ...
  previewChipText: { fontSize: SIZES.sm, color: COLORS.trackerColor, fontWeight: '600' },
  predCard: { marginBottom: 14 },
  cardTitle: { fontSize: SIZES.sm, fontWeight: '700', color: COLORS.textMuted, marginBottom: 8 },
  bigDate: { fontSize: SIZES.xxl, fontWeight: '800', color: COLORS.trackerColor },
  ...
  ovulationText: { fontSize: SIZES.xs, color: COLORS.accentDark, fontWeight: '500', flex: 1 },
  ...
  regularityText: { fontSize: SIZES.sm, fontWeight: '700' },
  ...
  riskBadgeText: { color: COLORS.white, fontSize: SIZES.xs, fontWeight: '700' },
  ...
  indicatorsTitle: { fontSize: SIZES.xs, fontWeight: '700', color: COLORS.textMuted, marginBottom: 6 },
  ...
  sectionTitle: { fontSize: SIZES.md, fontWeight: '700', color: COLORS.textPrimary, marginBottom: 10, marginTop: 4 },
  lifestyleCard: { marginBottom: 10 },
  lifestyleCategory: { fontSize: SIZES.base, fontWeight: '700', color: COLORS.textPrimary, marginBottom: 10 },
  ...
  doctorTitle: { fontSize: SIZES.base, fontWeight: '700', color: COLORS.danger },
