...
const styles = StyleSheet.create({
  ...
  sub: { color: 'rgba(255,255,255,0.7)', fontSize: 13, lineHeight: 19, marginTop: 6, marginBottom: 14, fontFamily: 'Nunito_400Regular' },
  ...
  noticeText: { color: 'rgba(255,255,255,0.8)', fontSize: 11, flex: 1, fontFamily: 'Nunito_400Regular' },
  ...
  cardTitle: { fontSize: 15, fontFamily: 'Nunito_800ExtraBold', marginBottom: 3 },
  optional: { fontSize: 12, fontFamily: 'Nunito_400Regular', color: '#8BA58D' },
  cardSub: { fontSize: 12, color: '#8BA58D', marginBottom: 12, fontFamily: 'Nunito_400Regular' },
  infoRow: { flexDirection: 'row', gap: 14 },
  infoField: { flex: 1 },
  infoLabel: { fontSize: 11, fontFamily: 'Nunito_700Bold', marginBottom: 6 },
  infoInput: { borderRadius: 10, paddingHorizontal: 12, paddingVertical: 10, fontSize: 15, fontFamily: 'Nunito_700Bold', borderWidth: 1 },
  ...
  genderText: { fontSize: 12, fontFamily: 'Nunito_700Bold' },
  ...
  customInput: { flex: 1, fontSize: 14, lineHeight: 20, minHeight: 40, fontFamily: 'Nunito_400Regular' },
  ...
  selectedText: { fontSize: 13, fontFamily: 'Nunito_400Regular' },
  selectedCount: { fontFamily: 'Nunito_800ExtraBold', color: '#059669' },
  ...
  analyzeBtnText: { color: '#fff', fontSize: 16, fontFamily: 'Nunito_800ExtraBold' },
  urgencyCard: { flexDirection: 'row', alignItems: 'center', gap: 14, borderRadius: 16, padding: 16, borderWidth: 1.5 },
  urgencyLabel: { fontSize: 15, fontFamily: 'Nunito_800ExtraBold', marginBottom: 3 },
  urgencyReason: { fontSize: 12, lineHeight: 17, fontFamily: 'Nunito_400Regular' },
  ...
  resultTitle: { fontSize: 14, fontFamily: 'Nunito_800ExtraBold' },
  condRow: { flexDirection: 'row', alignItems: 'flex-start', gap: 10, paddingBottom: 10 },
  condName: { fontSize: 14, fontFamily: 'Nunito_700Bold', marginBottom: 3 },
  condDesc: { fontSize: 12, lineHeight: 17, fontFamily: 'Nunito_400Regular' },
  probPill: { paddingHorizontal: 10, paddingVertical: 4, borderRadius: 10 },
  probText: { fontSize: 11, fontFamily: 'Nunito_800ExtraBold' },
  ...
  bulletNum: { width: 22, height: 22, borderRadius: 11, backgroundColor: '#ECFDF5', textAlign: 'center', fontSize: 11, fontFamily: 'Nunito_800ExtraBold', color: '#059669', lineHeight: 22 },
  bulletText: { flex: 1, fontSize: 13, lineHeight: 19, fontFamily: 'Nunito_400Regular' },
  doctorText: { fontSize: 13, lineHeight: 20, fontFamily: 'Nunito_400Regular' },
  disclaimer: { flexDirection: 'row', gap: 8, alignItems: 'flex-start', borderRadius: 12, padding: 14 },
  disclaimerText: { flex: 1, fontSize: 11, color: '#8BA58D', lineHeight: 16, fontFamily: 'Nunito_400Regular' },
  ...
  errorText: { flex: 1, fontSize: 13, color: '#EF4444', fontFamily: 'Nunito_600SemiBold' },
});
